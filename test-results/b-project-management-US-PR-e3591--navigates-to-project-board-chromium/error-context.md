...
- Name: b-project-management.spec.js >> US-PROJ-3: Open Project Board button inside the card modal navigates to project board
- Location: tests/e2e/b-project-management.spec.js:57:1
