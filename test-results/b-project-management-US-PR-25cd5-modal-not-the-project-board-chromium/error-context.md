...
- Name: b-project-management.spec.js >> US-PROJ-2: clicking a project card opens the edit modal, not the project board
- Location: tests/e2e/b-project-management.spec.js:37:1
