...
- Name: i-agent-presence.spec.js >> US-PRES-1: card with active agent presence shows a pulsing indicator on its face
- Location: tests/e2e/i-agent-presence.spec.js:64:1
