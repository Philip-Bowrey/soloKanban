...
- Name: a-workspace-setup.spec.js >> US-SETUP-1: blank workspace opens with zero projects and no console errors
- Location: tests/e2e/a-workspace-setup.spec.js:14:1
