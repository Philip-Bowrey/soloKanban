...
- Name: c-feature-cards.spec.js >> US-CARD-1: creating a feature card via column header button adds it to the list
- Location: tests/e2e/c-feature-cards.spec.js:24:1
