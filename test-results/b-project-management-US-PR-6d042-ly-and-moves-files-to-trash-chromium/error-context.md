...
- Name: b-project-management.spec.js >> US-PROJ-5: deleting a project removes the card immediately and moves files to trash
- Location: tests/e2e/b-project-management.spec.js:95:1
