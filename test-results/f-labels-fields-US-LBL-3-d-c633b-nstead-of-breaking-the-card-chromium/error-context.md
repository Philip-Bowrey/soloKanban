...
- Name: f-labels-fields.spec.js >> US-LBL-3: deleted label shows placeholder text instead of breaking the card
- Location: tests/e2e/f-labels-fields.spec.js:76:1
