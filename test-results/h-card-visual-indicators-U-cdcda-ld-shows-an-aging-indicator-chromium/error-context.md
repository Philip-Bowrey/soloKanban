...
- Name: h-card-visual-indicators.spec.js >> US-VIS-1: a card not updated past the staleness threshold shows an aging indicator
- Location: tests/e2e/h-card-visual-indicators.spec.js:66:1
